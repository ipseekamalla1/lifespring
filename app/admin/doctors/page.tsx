  ...
  return (
    <div className="p-6 space-y-6 min-h-screen bg-white">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-semibold text-[#4ca626]">Doctors</h1>
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            {filteredDoctors.map((doc) => (
              <tr key={doc.id} className="border-b hover:bg-green-50">
                ...
                <td className="px-4 py-3">{doc.patientsCount}</td>
